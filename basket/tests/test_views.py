...
class TestBasketView(TestCase): 
        def setUp(self):
            ...
            Product.objects.create(categories_id=1, title='django intermediate', created_by_id=1,
                                slug='django-beginners', price='20.00', image='django')
            Product.objects.create(categories_id=1, title='django advanced', created_by_id=1,
                                slug='django-beginners', price='20.00', image='django')
            self.client.post(
        ...
        def test_basket_delete(self):
            ...
            self.assertEqual(response.json(), {'qty': 1, 'cost': '20.00'})    
        ...
        def test_basket_update(self):
            ...
            self.assertEqual(response.json(), {'qty': 2, 'cost': '40.00'})